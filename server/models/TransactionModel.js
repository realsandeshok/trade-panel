...
const createTransaction = async (transaction) => {
    const { script_name, quantity, market_cost, brokerage, purchase_date, account_holder } = transaction;
    const result = await pool.query(
        ...
        [script_name, quantity, market_cost, brokerage, purchase_date, account_holder]
    );
    return result.rows[0];
};
